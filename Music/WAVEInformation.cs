...
namespace izolabella.Util.Music
{
    public class WAVEInformation
    {
        ...
        [JsonProperty(nameof(ChannelCount))]
        public short ChannelCount { get; set; }

        [JsonProperty(nameof(SampleRate))]
        public int SampleRate { get; set; }

        [JsonProperty(nameof(LengthInBytes))]
        public int LengthInBytes { get; set; }

        [JsonProperty(nameof(BytesPerSecond))]
        public long BytesPerSecond { get; set; }

        [JsonProperty(nameof(BitsPerSample))]
        public short BitsPerSample { get; set; }

        [JsonProperty(nameof(FileDuration))]
